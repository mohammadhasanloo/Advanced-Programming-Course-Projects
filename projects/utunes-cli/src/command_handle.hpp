...
const int GET_SIMILAR_USERS_SIZE = 5;
const int GET_RECOMMEDED_SIZE = 5;
...
public:
	...
	void GET_similar_users_function();
	void GET_similar_users_errors();
	void GET_recommeded_function();
	void GET_recommeded_errors();
